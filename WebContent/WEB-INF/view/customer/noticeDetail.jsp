...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<!-- noticeReg에서 서비스 요청 들어온것
		url -> http://localhost:8080/javaWebPrj/customer/noticeReg 
		noticeReg에서 상대경로를 타고 올라가야 한다. -->
	</head>
	<body>
		<div id="header">
			<div class="top-wrapper">
				<h1 id="logo"><a href="/"><img src="../resource/images/logo.png" alt="뉴렉처" /></a></h1>
				...
				<ul id="membermenu" class="clear">
					<li>
						<a href=""><img src="../resource/images/menu-myPage.png" alt="마이페이지" /></a>
					</li>
					<li>
						<a href="notice.jsp"><img src="../resource/images/menu-customer.png" alt="고객센터" /></a>
					</li>
				</ul>
			</div>
		</div>
			...
			<div class="top-wrapper clear">
				<div id="content">
					...
					<div id="notice-article-detail" class="article-detail margin-large" >						
						...
						<dl class="article-detail-row">
							...
							<dd class="article-detail-data">
								<a href="download?f=d.jpg">bg-namecard1.jpg</a>
							</dd>
						</dl>
					...
					<div class="margin-small" style="border-top: 1px solid #dfdfdf;">
						<dl class="article-detail-row">
							<dt class="article-detail-title">
								<a href="noticeDetail?c=${n.code+1}">▲ 다음글</a>
							</dt>
							<dd class="article-detail-data">
								${plus.title}
							</dd>
						...
						<dl class="article-detail-row">
							<dt class="article-detail-title">
								<a href="noticeDetail?c=${n.code-1}">▼ 이전글</a>
							</dt>
							<dd class="article-detail-data">
								${minus.title}
							</dd>
				...
				<div id="navi">
				    ...
				    <ul class="margin-small">
					    <li>
						    <a href="http://www.answeris.net"><img src="../resource/images/answeris.png" alt="앤서이즈" /></a>
					    </li>
					    <li>
