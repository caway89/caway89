...
<!-- 주의!! WEB-INF폴더 안에 디렉토리가 있다고 생각하면 안됨.. private영역이니까 -->
</head>
<body>
	<div id="header">
		<div class="top-wrapper">
			<h1 id="logo">
				<a href="/"><img src="../resource/images/logo.png" alt="뉴렉처" /></a>
			</h1>
		...
		<div class="top-wrapper clear">
			<div id="content">
				...
				<div id="notice-article-detail" class="article-detail margin-large">
					<!-- <form action="" method="post" enctype="application/x-www-form-urlencoded nul"> -->
					<form action="" method="post" enctype="multipart/form-data">
						<!-- 그래야 데이타 넘겨줄때 나누어서 보내줌 바이너리 같은경우는 특별하니까 스트림이 필요함 -->
			...
			<div id="navi">
				...
				<ul class="margin-small">
					<li><a href="http://www.answeris.net"><img
							src="../resource/images/answeris.png" alt="앤서이즈" /></a></li>
					<li><a href="http://www.microsoft.com"><img
							src="../resource/images/microsoft.png" alt="마이크로소프트" /></a></li>
					<li><a href="http://www.w3c.org"><img
							src="../resource/images/w3c.png" alt="W3C" /></a></li>
				</ul>
			</div>
		</div>
	</div>
