<div id="content">
            ...
            <table class="article-list margin-small">
               <caption class="hidden">공지사항 ${error}</caption>
               <thead>
                  <tr>
                     <th class="seq">번호</th>
               ...
               <tbody>
                  <c:forEach var="n" items="${list}">
                     <tr>
                        ...
                        <%-- <td>${n.code}</td> --%>
                        <td class="title">
                           <%-- <a href="noticeDetail?c=${n.code}"> --%> <a
                           href="noticeDetail?c=${n.code}">${n.title}</a> [${n.cmtCount}]
                           <c:forEach var="f" items="${n.noticeFiles}"> 
                                 ${f.name} 
                              </c:forEach>
                        </td>
